   <!-- javascript ================================================== -->
            ...
            <script type="{{asset('text/javascript" src="plugins/dataTables/dataTables.bootstrap.min.js')}}" ></script>  
            <script src="{{asset('plugins/datatables/jquery.dataTables.min.js')}}"></script> 
            <script type="{{asset('text/javascript" src="plugins/datepicker/bootstrap-datepicker.js')}}" charset="UTF-8"></script>
            <script type="{{asset('text/javascript" src="plugins/datepicker/bootstrap-datetimepicker.js')}}" charset="UTF-8"></script>
            <script type="{{asset('text/javascript" src="plugins/datepicker/locales/bootstrap-datetimepicker.uk.js')}}" charset="UTF-8"></script>
