        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
              ...
              <!-- /.col-lg-12 --> 
              <form class="form-horizontal span6" action="{{url('admin/saveusers')}}" method="POST">   
                @csrf  
                ...
                <div class="form-group">
                  <div class="col-md-8">
                    ...
                    <div class="col-md-8">
                      <input class="form-control input-sm" id="U_NAME" name="fullname" placeholder="User Fullname" type="text" value="">
                    </div>
                ...
                <div class="form-group">
                  <div class="col-md-8">
                    ...
                    <div class="col-md-8">
                      <input class="form-control input-sm" id="U_USERNAME" name="username" placeholder="Account Username" type="text" value="">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-md-8">
                    ...
                    <div class="col-md-8">
                      <input class="form-control input-sm" id="U_PASS" min="3" name="password" placeholder="Account Password" type="Password" value="" required>
                    </div>
                  </div>
                </div>
